...
impl OracleAction {
    ...
    fn display_label(self) -> &'static str {
        match self {
            Self::ProposeSource => "Propose source (local draft)",
            Self::EditDefinition => "Edit definition (local draft)",
            Self::BackSource => "Back source (local draft)",
            Self::OpeningPrint => "Opening print (local draft)",
            Self::SubmitUpdate => "Commit update (local draft)",
            Self::Challenge => "Challenge (local draft)",
            Self::ClaimReward => "Claim reward (local draft)",
...
struct LabApp {
    ...
    help_pages: HashMap<String, GitbookPage>,
    help_page_cache_order: VecDeque<String>,
    ...
    status: String,
    issues: Vec<String>,
    detail_cache: HashMap<String, DishDetail>,
    chart_cache: HashMap<String, chart::EmbeddedChart>,
